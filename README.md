...
- **Signals no serviço**: Expandiria o uso de Signals para o estado interno do serviço (`signal<User[]>([])`), reduzindo a dependência de RxJS nos casos que não envolvem streams reais.
